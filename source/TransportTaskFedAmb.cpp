...
///////////////////////////////////////////////////////////////////////////////
void TransportTaskFedAmb::synchronizationPointRegistrationSucceeded( std::wstring const &label )
	throw(FederateInternalError)
{
	wcout << L"Successfully registered sync point: " << label << endl;
}

void TransportTaskFedAmb::synchronizationPointRegistrationFailed( std::wstring const &label,  SynchronizationFailureReason reason )
	throw(FederateInternalError)
{
	wcout << L"Failed to register sync point: " << label << endl;
}

void TransportTaskFedAmb::announceSynchronizationPoint( std::wstring const &label, VariableLengthData const &theUserSuppliedTag )
	throw(FederateInternalError)
{
...
void TransportTaskFedAmb::federationSynchronized( std::wstring const &label )
	throw(FederateInternalError)
{
...
//////////////////////////////// Time Callbacks ///////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void TransportTaskFedAmb::timeRegulationEnabled( LogicalTime const &theFederateTime) 
...
void TransportTaskFedAmb::timeConstrainedEnabled( LogicalTime const &theFederateTime ) 
			throw ( InvalidLogicalTime, 
...
void TransportTaskFedAmb::timeAdvanceGrant( LogicalTime const &theTime) 
			throw ( InvalidLogicalTime, 
...
//                         //
void TransportTaskFedAmb::discoverObjectInstance( ObjectInstanceHandle theObject, 
...
//                                 // 
void TransportTaskFedAmb::reflectAttributeValues( ObjectInstanceHandle theObject, 
 ...
 */
std::wstring
TransportTaskFedAmb::variableLengthDataToWstring(const rti1516::VariableLengthData&
variableLengthData)
{
 ...
 */
void TransportTaskFedAmb::receiveInteraction( InteractionClassHandle theInteraction, ParameterHandleValueMap const &theParameterValues, VariableLengthData const &theUserSuppliedTag, OrderType sentOrder, TransportationType theType) throw (InteractionClassNotRecognized, InteractionParameterNotRecognized, InteractionClassNotSubscribed, FederateInternalError )
{
...
void TransportTaskFedAmb::receiveInteraction( InteractionClassHandle theInteraction, 
...
//                       //
void TransportTaskFedAmb::removeObjectInstance( ObjectInstanceHandle theObject, 
		VariableLengthData const &theUserSuppliedTag, 
		OrderType sentOrder) 
